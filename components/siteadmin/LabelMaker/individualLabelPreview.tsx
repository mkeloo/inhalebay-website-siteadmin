    ...
    (
        ...
        return (
            <Card
                ...
                style={{ width: OUTER_WIDTH_PX, height: LABEL_HEIGHT_PX }}
            >
                {/* CENTERED CONTENT BLOCK at exactly 3" */}
                <div
                    className="h-full mx-auto flex flex-row items-center justify-between gap-2"
