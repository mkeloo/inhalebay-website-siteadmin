...
import { fetchAllHempLabCertificates, fetchCertificatesURL, HempLabCertificates } from "@/app/actions/hempLabCOA";
...
export default function HempCertificateOfAnalysisClient() {
