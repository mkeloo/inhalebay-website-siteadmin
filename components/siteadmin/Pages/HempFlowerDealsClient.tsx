...
import { createHempFlowerDealsColumns } from "@/app/dashboard/product-content/hemp-flowers/columns";
...
} from "@/app/actions/hempFlowerDeals";
...
export default function HempFlowerDealsClient() {
